package inu.appcenter.finalterm.config.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {  // Security 커스텀하게 사용
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(HttpMethod.PATCH, "/ADMIN/category/{categoryId}").hasRole("ADMIN")
                .antMatchers(HttpMethod.DELETE, "/ADMIN/category/{categoryId}", "/ADMIN/post/{postId}", "/ADMIN/comment/{commentId}").hasRole("ADMIN")
